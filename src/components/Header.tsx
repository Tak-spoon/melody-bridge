  ...
  return (
    <header className="bg-[#23160e] px-3 py-2 shadow-md flex justify-between items-center shrink-0 z-20 border-b border-[#3f2719]">
      ...
      <div className="flex gap-1.5">
        <button 
          onClick={onOpenRules}
          className="flex items-center gap-1 px-2.5 py-1 bg-[#180f09] hover:bg-[#2e1c11] text-amber-200 text-xs font-bold rounded-lg border border-amber-700/50 transition active:scale-95 shadow-xs"
          title="遊び方・ルールを確認"
        >
