...
export const PUZZLE_CHAPTERS: PuzzleChapter[] = [
    ...
    stages: [
      {
        id: 'ch1_1',
        title: '1-1: 音階の前後拡張',
        description: '山札からカードを引き、場のスケール [D・E・F] の先頭に手札から付け札して、残った不要なカードを捨ててアガりましょう。',
      ...
      {
        id: 'ch1_2',
        title: '1-2: マイナーセブンスへの進化',
        description: '山札をドローし、場のDmコードに [C] を付け札して「Dm7」に進化させ、残った不要なカードを捨ててアガりましょう。',
      ...
      {
        id: 'ch1_3',
        title: '1-3: ダブル付け札（コード＆スケール）',
        description: '山札をドローし、手札の2枚をそれぞれ場の異なるセットに付け札して、残った不要なカードを捨ててアガりましょう。',
      ...
      {
        id: 'ch1_4',
        title: '1-4: 4和音 CM7 からのスワップ',
        description: '4枚上限の CM7 に [A] をスワップして [B] を回収し、スケールへ流し込んで残りを捨ててアガりましょう！',
      ...
      {
        id: 'ch1_5',
        title: '1-5: 4和音 Bm7(♭5) からのスワップ',
        description: '4枚上限の Bm7(♭5) に [G] をスワップして G7 にし、抜けた [A] をスケールへ流してアガりましょう！',
      ...
      {
        id: 'ch1_6',
        title: '1-6: スケール2枚連続付け札',
        description: '手札の2枚を同じスケールの前後にそれぞれ付け札し、残った不要なカードを捨ててアガりましょう。',
      ...
      {
        id: 'ch1_7',
        title: '1-7: ドミナント7th（G7）への進化',
        description: 'Gコードに7度音 [ファ] を付けて「G7」に進化させ、残った不要なカードを捨ててアガりましょう。',
      ...
      {
        id: 'ch1_8',
        title: '1-8: 4和音 CM7 からの Am7 リハーモナイズ',
        description: '4枚上限の CM7 に [A] をスワップして [B] を手元に引き継ぎ、スケールへ流し込んでアガりましょう！',
      ...
      {
        id: 'ch1_9',
        title: '1-9: メジャー7th（FM7）への進化',
        description: 'Fコードに7度音 [ミ] を付けて「FM7」へ進化させ、残った不要なカードを捨ててアガりましょう。',
      ...
      {
        id: 'ch1_10',
        title: '1-10: 4和音 Dm7 からの再構築スワップ',
        description: '4枚上限の Dm7 に [E] をスワップして FM7 にし、抜けた [D] をスケールへ流してアガりましょう！',
  ...
  },
  {
    ...
    stages: [
      {
        id: 'ch2_1',
        title: '2-1: 4和音 CM7 からのスケール流し込み',
        description: '付け札できない 4和音 CM7 に [A] をスワップして [B] を手元に引き継ぎ、スケールへ流し込んで残りを捨ててアガりましょう！',
      ...
      {
        id: 'ch2_2',
        title: '2-2: 4和音 FM7 からの [E] 再構築スワップ',
        description: '4枚上限の FM7 [F・A・C・E] に [D] をスワップして [E] を手元に引き継ぎ、スケールへ流してアガりましょう！',
      ...
      {
        id: 'ch2_3',
        title: '2-3: 4和音 Am7 からの脱出スワップ',
        description: '4和音 Am7 から [A] をスワップで手元に引き継ぎ、スケールへ流し込んで残りを捨ててアガりましょう！',
      ...
      {
        id: 'ch2_4',
        title: '2-4: 4和音 Bm7(♭5) の活用',
        description: '4枚上限の Bm7(♭5) をスワップして G7 に変化させ、[A] をスケールへ流してアガりましょう！',
      ...
      {
        id: 'ch2_5',
        title: '2-5: 付け札からの逆転4和音スワップ',
        description: '先にスケールへ付け札し、4和音 G7 をスワップしてアガりましょう！',
      ...
      {
        id: 'ch2_6',
        title: '2-6: 4和音 FM7 からのスワップ流し込み',
        description: '4和音 FM7 [F・A・C・E] に [D] をスワップして Dm7 にし、[E] をスケールへ流してアガりましょう！',
      ...
      {
        id: 'ch2_7',
        title: '2-7: 4和音 G7 からのリハーモナイズ連鎖',
        description: '4和音 G7 から必要な音をスワップで手元に引き継ぎ、スケールを完成させてアガりましょう！',
      ...
      {
        id: 'ch2_8',
        title: '2-8: 4和音と3和音の架け橋',
        description: '4和音 CM7 からスワップで [B] を引き継ぎ、スケールへ流し込んでアガりましょう！',
      ...
      {
        id: 'ch2_9',
        title: '2-9: ダブルスケールへの同時流し込み',
        description: '2つの異なるスケールへ手札を綺麗に振り分け、不要なカードを捨ててアガりましょう。',
      ...
      {
        id: 'ch2_10',
        title: '2-10: 4和音 Em7 からのスワップ',
        description: '4和音 Em7 [E・G・B・D] に [F] をスワップして G7 に変化させ、[E] をスケールへ流してアガりましょう！',
  ...
  },
  {
    ...
    stages: [
      {
        id: 'ch3_1',
        title: '3-1: ハーフディミニッシュ・リハーモナイズ連鎖',
        description: '手詰まりの状況から、4和音 Bm7(♭5) を G7 にリハーモナイズしてアガりましょう！',
      ...
      {
        id: 'ch3_2',
        title: '3-2: 4和音 Dm7 からの FM7 転換',
        description: 'Dm7 [D・F・A・C] に [E] をスワップして FM7 に組み替え、残りを捨ててアガりましょう！',
        hint: '① Dm7 に [E] をスワップして [D] を回収！\n② 抜けた [D] をスケール [E・F・G] の先頭へ付け札！\n③ 残った不要なカードを捨ててクリア！',
      ...
      {
        id: 'ch3_3',
        title: '3-3: 3つのセットを跨ぐ大連鎖',
        description: '4和音 CM7 でスワップ ➔ 回収した音をコードBに付け札 ➔ 手札の音をスケールCに付け札！',
      ...
      {
        id: 'ch3_4',
        title: '3-4: 転回形 Em7 からの G7 創造',
        description: 'Em7 [E・G・B・D] に手札の [F] をスワップして G7 にし、[E] をスケールへ流してアガりましょう！',
      ...
      {
        id: 'ch3_5',
        title: '3-5: 孤立カード2枚からの全消しマジック',
        description: '4和音 CM7 をスワップしてキーカードを受け取り、スケールを完成させて全消しせよ！',
      ...
      {
        id: 'ch3_6',
        title: '3-6: 5音スケールへの限界突破付け札',
        description: 'スケールの限界である5枚までカードを伸ばし、残りを付け札してアガりましょう！',
      ...
      {
        id: 'ch3_7',
        title: '3-7: ドミナント連鎖（4和音 G7 ➔ スケール）',
        description: '4和音 G7 から [F] を手元に引き継ぎ、スケール [C・D・E] に流し込んでアガりましょう！',
      ...
      {
        id: 'ch3_8',
        title: '3-8: クローズドボイシングの極限',
        description: '4和音 Dm7 [D・F・A・C] に [E] をスワップして FM7 に組み替え、アガりましょう！',
        hint: '① Dm7 に [E] をスワップして [D] を回収！\n② 抜けた [D] をスケール [E・F・G] の先頭へ付け札！\n③ 残った不要なカードを捨ててクリア！',
      ...
      {
        id: 'ch3_9',
        title: '3-9: 3和音2つからの同時進化',
        description: '場にある2つの3和音の両方に付け札して2つの4和音を同時に創り、アガりましょう！',
      ...
      {
        id: 'ch3_10',
        title: '3-10: 詰めメロディ・グランドフィナーレ',
        description: '4和音 Bm7(♭5) をスワップして [A] を引き継ぎ、2つのスケールを同時に完成させてフィナーレ！',
